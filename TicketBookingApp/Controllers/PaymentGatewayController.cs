...
namespace TicketBookingApp.Controllers
{
    ...
    public class PaymentGatewayController : ControllerBase
    {
        ...
        public PaymentGatewayController(SSLCommerzService ssl,ApplicationDbContext context)
        {
            _ssl = ssl;
            _context = context;
        }
        ...
        public async Task<IActionResult> PaymentSuccess([FromForm] string val_id, [FromForm] string tran_id, CancellationToken ct)
        {
            ...
            return Redirect($"https://localhost:7143/PaymentGateway/success?tran_id={tran_id}");
        }
